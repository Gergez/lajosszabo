...
<head>
  ...
  <title>Az oldal nem található - Magyar Dialogikus Iskola</title>


  <link rel="stylesheet" href="./css/main/general.css">
  <link rel="stylesheet" href="./css/main/style.css">
  <link rel="stylesheet" href="./css/pagenotfound/style.css">
...
<body>
  ...
  <script type="text/javascript" src="translations/pagenotfound/language.json"></script>
  ...
  <div id="main_container" class="main_container">
    ...
    <div class="page_container">
      ...
      <div class="title">
        <h1 id="magyar_dialogikus_iskola">Magyar dialogikus iskola</h1>
      </div>

      <div class="page_not_found">
        <h2 id="vissza_a_fooldalra">Az oldal nem található.<a href="index.html"> </br>Vissza a Magyar dialogikus iskola főoldalára.</a></h2>
      </div>
  ...
  <script type="module" src="./sablon.js" defer></script>
