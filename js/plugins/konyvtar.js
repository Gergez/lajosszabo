...
irasok.addEventListener('click', () =>{
    irasokContent.style.display = "block";
    galeriaContent.style.display = "none";
    esemenyekContent.style.display = "none";
});

galeria.addEventListener('click', () =>{
    galeriaContent.style.display = "block";
    irasokContent.style.display = "none";
    esemenyekContent.style.display = "none";
});
esemenyek.addEventListener('click', () =>{
    esemenyekContent.style.display = "block";
    galeriaContent.style.display = "none";
    irasokContent.style.display = "none";
});
